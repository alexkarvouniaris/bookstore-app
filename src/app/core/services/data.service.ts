...
export class DataService {
  @Output() bookInserted: EventEmitter<boolean> = new EventEmitter<boolean>();
  constructor() {}
  ...
  insertBook(book: IBook): Observable<boolean> {
    books.push(book);
    return of(true);
  }
  ...
  getRelatedBooks(categories: string[], isbn: string): Observable<Array<IBook[]>> {
    let results: Array<IBook[]> = [];
    categories.forEach((value) => {
      const relatedBooks = books.filter((b) => b.categories.includes(value) && b.isbn !== isbn);
      results.push(relatedBooks);
    });
    return of(results);
  }
}
...
export const books = [
  ...
  },
  {
    ...
    rating: 5,
    image:
      'https://images-na.ssl-images-amazon.com/images/I/51LHTs-4ziL._SX331_BO1,204,203,200_.jpg',
  },
  {
    isbn: '9781593277574',
  ...
  },
  {
    ...
    rating: 3,
    image:
      'https://i5.walmartimages.com/asr/8810a202-8840-49ad-bc5c-a1ff168a7769.1d51bdb357427a482d4fcfe7ccf420bb.jpeg?odnWidth=612&odnHeight=612&odnBg=ffffff',
  },
  {
    isbn: '9781449331818',
  ...
  },
  {
    ...
    rating: 5,
    image:
      'https://web.webstorage.gr/MEDIA/books/bookdata/largeImages/9781430218333.jpg',
  },
  {
    isbn: '9781484242216',
